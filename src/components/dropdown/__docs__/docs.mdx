...
<Canvas>
  <div style={{display: 'flex', justifyContent: 'center'}}>
    <div style={{boxShadow: "rgba(99, 99, 99, 0.2) 0px 2px 8px 0px", width: "300px"}}>
      <DropdownHeader searchValue="" searchPlaceholder="Search for an item" onBackClick={() => {}}>
        Example Header
      </DropdownHeader>
    </div>
  </div>
...
When you source is async it is quite simple to get the information and display it in a dropdown. You can also
