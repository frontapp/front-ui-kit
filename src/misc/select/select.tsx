...
function maybeRenderHeader(label?: string, searchPlaceholder?: string, searchValue?: string, onSearchChange?: (value: string) => void) {
  if (!label)
    return null;
  return (
    <DropdownHeader searchPlaceholder={searchPlaceholder} searchValue={searchValue} onSearchChange={onSearchChange}>
      {label}
    </DropdownHeader>
  );
}
